...
public:
    ...
    public:
        //constructor
        Stroke(string name, vector<pair<int,int>> points){
        this->name = name;
        this->points = points;
    }
        string name;
